...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference("Lecture.count") do
      post lectures_url, params: { lecture: { category: @lecture.category, description: @lecture.description, name: @lecture.name} }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { category: @lecture.category, description: @lecture.description, name: @lecture.name} }
